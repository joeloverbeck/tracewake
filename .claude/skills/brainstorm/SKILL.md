...
Present design section by section, get approval per section
        |
        v
[If product-behavior] Validate against docs/02_FOUNDATIONAL_INVARIANTS.md
        |
        v
...
Throughout this skill, the **alignment authority** is `docs/02_FOUNDATIONAL_INVARIANTS.md` — tracewake's constitution of hard rules (`INV-001` … `INV-036`). References to "the invariants" or an "INV-NNN" principle all point there.
...
| Amend `docs/02_FOUNDATIONAL_INVARIANTS.md` (constitutional change) | edit in place — flag as a constitution amendment, require explicit sign-off |
