...
Throughout this skill, the **alignment authority** is `docs/0-foundation/02_FOUNDATIONAL_INVARIANTS.md` — tracewake's constitution of hard rules (`INV-001` … `INV-036`). References to "the invariants" or an "INV-NNN" principle all point there.
