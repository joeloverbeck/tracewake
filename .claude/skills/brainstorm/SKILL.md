...
| Foundation-amendment captured as a spec (proposal, not edited in place) | `specs/NNNN_TITLE.md` — proposes substance + home, no `INV-###` / no ratified wording; the spec stages the amendment without enacting it, sign-off attaches to the eventual foundation edit (see §Deliverable classification) |
