...
- **0048 evidence:** `reports/0048_foundational_conformance_hardening_acceptance.md` explicitly separates measured path-under-test evidence from registry declaration metadata, records the focused mutation denominator, and triages eight surviving mutants instead of counting them as killed.
...
- **0048 evidence:** `reports/0048_foundational_conformance_hardening_acceptance.md` maps tickets `0048FOUCONHAR-001` through `0048FOUCONHAR-007` to replay, holder-known, world-step, temporal-authority, interval-stop, behavioral-lock, and parity witness classes before closing the capstone.
...
- **0048 evidence:** `reports/0048_foundational_conformance_hardening_acceptance.md`, `crates/tracewake-core/tests/reservation_body_exclusive_census.rs`, `crates/tracewake-core/tests/generative_lock.rs`, and `crates/tracewake-tui/tests/playable_capability_parity.rs` record behavior witnesses, adversarial measurement probes, and focused mutation results rather than artifact-presence-only locks.
