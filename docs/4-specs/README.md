...
- `archive/specs/0006_PHASE_3A_NEEDS_ROUTINES_AND_NO_HUMAN_DAY_HARDENING_SPEC.md` — completed corrective Phase 3A hardening slice; landed the no-human / replay / debug / TUI / actor-known gates with caveats recorded in `SPEC_LEDGER.md`.
