...
**Phase 3A is still in hardening.**  
**Phase 3B and Phase 4 are blocked until Spec 0008 gates pass.**

At target commit `8e3cf3eccb94372b7873846ae952441fc1ca44d0`, Phase 3A contains useful scaffolding but is not safe to build on as completed architecture. The no-human autonomy path still permits shortcut debt around actor-known boundaries, direct routine/need dispatch, after-the-fact traces, proposal-echo validation, string diagnostics, and weak proof gates.
...
| 0008 | Phase 3A Anti-Contamination Hardening | **Required / blocking** | Establishes canonical actor-decision transaction, sealed provenance-rich actor-known context, typed diagnostics/replay, authoritative pipeline validation state, adversarial fixtures, and anti-regression gates. Must pass before Phase 3B/Phase 4. |
...
Do not write any of the following until Spec 0008 gates pass:
...
Acceptable wording before Spec 0008 passes:

- “Phase 3A contains partial scaffolding and requires Spec 0008 hardening.”
- “No-human ordinary-life proof is not yet accepted.”
- “Phase 3B/Phase 4 remain blocked pending actor-known autonomy hardening.”
