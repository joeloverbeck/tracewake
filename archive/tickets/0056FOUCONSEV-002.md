...
2. Spec `archive/specs/0056_FOUNDATIONAL_CONFORMANCE_SEVENTH_HARDENING_*.md` §4.2 + §10.2 + §9 govern this ticket; the operator/debug launch UX is a spec-assigned implementer-recorded choice (item 3). Driver F7-02 in `reports/0047-foundational-hardening-research-report-seventh-pass.md`.
