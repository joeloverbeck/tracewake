...
**Deps**: `archive/tickets/0017PHA3ATICLED-008.md`, `0017PHA3ATICLED-009` (leaf set — transitively covers `-001`…`-007`; the conformance rows cite every implemented surface); `specs/0017_PHASE_3A_TICK_LEDGER_EPISTEMIC_STALENESS_REPLAY_PAYLOAD_EVIDENCE_AND_GENERATIVE_LOCK_HARDENING_SPEC.md` (ORD-HARD-034 + §6)
