...
**Deps**: `tickets/0018PHA3APROWIT-008.md`, `tickets/0018PHA3APROWIT-009.md`, `tickets/0018PHA3APROWIT-010.md` (leaf set — their transitive Deps cover tickets 001–007); `specs/0018_PHASE_3A_PROVENANCE_WITNESS_EPISODE_REPLAY_EVIDENCE_GENERATIVE_REACHABILITY_AND_SEED_EPISTEMICS_HARDENING_SPEC.md` (§7)
