...
use crate::actions::{ActionEffect, ActionRegistry, ActionScope};
use crate::agent::need::{NeedKind, NEED_MAX};
use crate::agent::routine::RoutineDiagnosticKind;
use crate::agent::{RoutineFamily, RoutineStepProposal};
use crate::epistemics::observation::EPISTEMIC_RECORD_SCHEMA_V1;
use crate::epistemics::{PrivacyScope, SourceRef};
use crate::events::{EventCause, InitialBeliefSourceKind};
use crate::ids::{ActionId, FoodSupplyId, PlaceId, WorkplaceId};
...
pub use crate::content::schema::{content_field_registry, ValidationPhase};
use crate::content::serialization::{deserialize_fixture, serialize_fixture, SerializationError};
...
fn validate_location_reference(
    location: &Location,
    actors: &BTreeSet<crate::ids::ActorId>,
    places: &BTreeSet<PlaceId>,
    containers: &BTreeSet<crate::ids::ContainerId>,
...
fn planner_intended_seed_text(
    belief: &crate::content::schema::InitialBeliefSchema,
...
mod tests {
    use super::*;
    use crate::agent::routine::{RoutineDiagnosticKind, RoutineStepParseError};
    ...
    fn phase3a_routine_typed_modes_windows_and_direct_ops_are_rejected() {
        ...
        fixture
            .day_windows
            .push(crate::content::schema::DayWindowSchema {
                actor_id: ActorId::new("actor_tomas").unwrap(),
