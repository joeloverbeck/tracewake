...
use crate::agent::{NeedKind, RoutineCondition, RoutineFamily, RoutineStep};
use crate::epistemics::{Channel, Confidence, PrivacyScope, Proposition, SourceRef, Stance};
use crate::events::{EventCause, InitialBeliefSourceKind};
use crate::ids::{
...
pub enum SerializationError {
    ...
    Proposition(crate::epistemics::proposition::PropositionParseError),
    Confidence(crate::epistemics::observation::ConfidenceError),
}

impl From<crate::ids::IdError> for SerializationError {
    fn from(value: crate::ids::IdError) -> Self {
        Self::Id(value)
    }
}

impl From<crate::epistemics::proposition::PropositionParseError> for SerializationError {
    fn from(value: crate::epistemics::proposition::PropositionParseError) -> Self {
        Self::Proposition(value)
    }
}

impl From<crate::epistemics::observation::ConfidenceError> for SerializationError {
    fn from(value: crate::epistemics::observation::ConfidenceError) -> Self {
...
fn split_ids<T>(
    value: &str,
    parse: impl Fn(&str) -> Result<T, crate::ids::IdError>,
...
mod tests {
    ...
    use crate::ids::{ActionId, ContentManifestId, EventId};
