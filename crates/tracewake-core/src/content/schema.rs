...
use crate::events::InitialBeliefSourceKind;
use crate::ids::{
...
use crate::content::validate::FixtureValidationToken;
...
impl RoutineTemplateSchema {
    pub fn to_template(
        &self,
    ) -> Result<crate::agent::RoutineTemplate, crate::agent::RoutineTemplateError> {
        crate::agent::RoutineTemplate::new(
