...
const MUTANTS_BASELINE_NORMALIZED_COUNT: usize = 44;
const MUTANTS_BASELINE_NORMALIZED_FNV1A64: u64 = 0x2829_7e34_c777_adc7;
...
fn mutation_baseline_misses_are_pinned_and_ledgered() {
    ...
    let unrecorded_floor_raise_ledger = MUTANTS_BASELINE_LEDGER.replace(
        "baseline-delta: normalized-count=44 fnv1a64=28297e34c777adc7",
        "baseline-delta: normalized-count=45 fnv1a64=28297e34c777adc7",
    );
    assert!(
